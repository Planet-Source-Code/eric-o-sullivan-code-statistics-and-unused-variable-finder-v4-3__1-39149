...
Private Sub timText_Timer()
    ...
    Dim udtMask As clsBitmap
    Dim intTextHeight As Integer
    Dim lngStartingTick As Long
    
    Static udtSurphase As New clsBitmap
    ...
    Call udtBmp.SetBitmap(picText.ScaleHeight, _
                          ...
                          vbWhite)
    Call udtMask.SetBitmap(picText.ScaleHeight, _
                           picText.ScaleWidth)
    ...
    Call udtSurphase.Pause(WAIT - (GetTickCount - lngStartingTick))
End Sub
